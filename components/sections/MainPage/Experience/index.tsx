        ...
        <section id="experience" className="bg-background-secondary">
            <div className="container px-6 pt-18 pb-8 sm:px-10 sm:pt-24">
                ...
                <div className="lg:hidden">
                    {careerItems.map((item) => (
                        <article key={item.company} className="border-t border-t-muted py-10 last:border-b last:border-b-muted">
                            <div className="mb-9">
                ...
                <div className="flex flex-col items-start justify-between gap-6 pt-10 sm:pt-12 lg:flex-row lg:items-end">
